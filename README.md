...
[![CI](https://github.com/Roberdan/convergio-backup/actions/workflows/ci.yml/badge.svg)](https://github.com/Roberdan/convergio-backup/actions/workflows/ci.yml)
[![License: Convergio Community](https://img.shields.io/badge/license-Convergio%20Community-blue)](https://github.com/Roberdan/convergio-backup/blob/main/LICENSE)
...
```mermaid
graph LR
    CRATE[convergio-backup] --> SDK[convergio-sdk]
    SDK --> T[types]
    SDK --> TEL[telemetry]
    SDK --> DB[db]
    SDK --> SEC[security]
...
```toml
[dependencies]
convergio-backup = { git = "https://github.com/Roberdan/convergio-backup", tag = "v0.1.0" }
```
